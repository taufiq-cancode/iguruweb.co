<section id="faq" class="section section-height-3 bg-light border border-bottom-0 m-0">
    <div class="container">
        <h2 class="text-10 font-weight-normal text-color-dark mb-4 line-height-4 text-center"><span class="text-color-primary font-weight-bold ">Frequently Asked </span> Questions</h2>
        <div class="row">
            <div class="col">
                <div class="row">
